        ...
        - lifecycle:
            preStop:
              exec:
                ...
                - "10"
  ```
4. Не забывайте выставлять limits и requests для ваших контенйнеров в pod чтобы k8s использовал requests для плаинрования, а limits для ограничения конкуренции за ресуурсов на node
