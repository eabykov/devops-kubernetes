...
Чарты нужны чтобы было легко обьеденить группу ресурсов (Deployment, Service, Configmap и прочие) необходимую для работы приложения, версионировать (обновлять), публиковать (как один файл) и делиться ими
